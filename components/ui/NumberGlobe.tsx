...
const NumberGlobe = () => {
  ...
  return (
    <div className="flex flex-row items-center justify-center sm:py-0 h-screen md:h-auto dark:bg-black-100 bg-white relative w-full">
