...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    "--shade":
      "radial-gradient( farthest-corner circle at var(--m-x) var(--m-y),rgba(138,43,226,0.1) 12%,rgba(148,0,211,0.15) 20%,rgba(186,85,211,0.25) 120% ) var(--bg-x) var(--bg-y)/300% no-repeat",
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[320px] [aspect-ratio:4/3]"
      ref={refElement}
      onPointerMove={(event) => {
